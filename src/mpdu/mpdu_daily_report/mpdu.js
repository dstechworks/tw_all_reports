...
async function dailyReportOnlineOffline() {
    // console.log("\n");
    // console.log("===============================================");
    // console.log("       DAILY ONLINE/OFFLINE REPORT MAKING START        ");
    // console.log("===============================================");
        ...
        timeIntervals.forEach((interval, index) => {
            ...
            if (deviceData && deviceData.hourly_status) {
                try {
                    ...
                    // Convert current_date from "2025-01-09" to "09-01-2025" format
                    ...
                    if (hourlyStatus[searchKey]) {
                        status = hourlyStatus[searchKey] === 'online' ? 1 : 0;
                    } else {
                        ...
                        if (availableKeys.length > 0) {
                            // Use the first available key for this hour and AM/PM
                            const closestKey = availableKeys[0];
                            status = hourlyStatus[closestKey] === 'online' ? 1 : 0;
                        }
                    }
                } catch (error) {
